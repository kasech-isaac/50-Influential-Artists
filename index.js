...
function getArtistByIndex(id, array) {
    ...
    return `The artist at index ${id} is ${array[6].name}.`
  }
  console.log(getArtistByIndex(6, artists))
...
*/
function removeArtist(id, array) {
  return delete array[id]
   
  }
  console.log(removeArtist(0, artists))
...
return artists.push(array)
    
}
addArtist({
id: 20,
name: "Kasech Isaac", 
years: "March-13-1994 - May-1-2020",
genre: "Web Design", 
nationality: "Ethiopian",
bio: " Kasech Isaac is Ethiopan artist. She has done more than 40 paints the last 10 years.",
})
console.log(artists)
